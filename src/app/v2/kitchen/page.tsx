...
export default function KitchenHome() {
  ...
  return (
    <V2Shell
      ...
      title="Kitchen costs"
      description="Track supplier spend, compare recent weeks, and open the invoices behind every total."
      actions={<Link href="/v2/bills" className="bp-btn">Open bills</Link>}
    >
