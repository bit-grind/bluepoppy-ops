...
export default function BillsPage() {
  ...
  useEffect(() => {
    async function init() {
      ...
      mePromise.then(async (meRes) => {
        if (meRes?.ok) {
          try {
            ...
            if (me.isGuest) { window.location.href = '/v2'; return }
      ...
      if (params.get('xero_connected') === '1') {
        ...
        window.history.replaceState({}, '', '/v2/bills')
  ...
  return (
    <V2Shell
      ...
      title="Bills"
      description="Search invoice lines, filter supplier bills, and inspect extracted items or source PDFs."
      wide
    >
